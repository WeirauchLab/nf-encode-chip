...
nextflow pull WeirauchLab/nf-encode-chip
...
git clone WeirauchLab/nf-encode-chip
...
nextflow run WeirauchLab/nf-encode-chip ...
...
nextflow run WeirauchLab/nf-encode-chip --input samplesheet.csv --outdir results --fasta /path/to/genome.fa
